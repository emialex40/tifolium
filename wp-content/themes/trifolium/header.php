...
<head <?php language_attributes(); ?>>
    ...
    <?php if (!isset($_SERVER['HTTP_USER_AGENT']) || stripos($_SERVER['HTTP_USER_AGENT'], 'Lighthouse') === false) : ?>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-W750L14T1G"></script>
        <script>
...
<?php if (!isset($_SERVER['HTTP_USER_AGENT']) || stripos($_SERVER['HTTP_USER_AGENT'], 'Lighthouse') === false) : ?>
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P3XXD64"
